    ...
    <div class="form-row">
        <div class="col-md-6">
            ...
            <div class="input-group mb-2">
                ...
                <input type="text" id="ccn" name= "ccn" autocomplete="off" class="ccNumber form-control col-md-8" value="" placeholder="0-00-00000" maxlength="10" pattern="^\w{1}-\d{2}-\d{5}$" title="Follow the following format. e.g. I-10-00001" onkeypress='validate(event)'> {{-- QUERY HERE --}}
            </div>
        </div>
        <div class="col-md-6">
...
<div class="form-group">
    <div class="form-row">
        ...
        <div class="col-md-6">
            ...
            <div class="">
            <input type="text" id="acmo" name="acmo" class="form-control" value="" disabled> {{-- QUERY HERE --}}
            </div>
        </div>
    </div>
</div>
    ...
    <div class="form-row">
        <div class="col-md-6">
            <label for="natureName">Nature of Case</label>
                <div class="">
                    <textarea class="form-control" name="natureName" id="natureName" style="width:100%;font-size:15px;resize:none;" rows="2" disabled></textarea>{{-- QUERY HERE --}}
                </div>
        </div>
        <div class="col-md-6">
...
<div class="form-group">
    <div class="form-row">
        <div class="col-md-12">
            <div class="">
                <input type="hidden" id="description" name="description" class="form-control" value="Encoder Insert CCN">
