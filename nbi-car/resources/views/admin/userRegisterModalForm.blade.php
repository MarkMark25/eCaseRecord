    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col-md-6">
                ...
                <input id="password" type="password" minlength="8" maxlength="16" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
            ...
            <div class="col-md-6">
                ...
                <input id="password-confirm" type="password" minlength="8" maxlength="16" class="form-control" name="password_confirmation" required>
            </div>
        </div>
    </div>
    <div class="form-group">
