...
<!-- /.container-fluid -->
    ...
    <div id="content-wrapper">
        ...
        <button class="btn" href="/" data-toggle="modal" data-target="#addCaseNature"><i class="fa fa-plus-circle"></i> Add Case Nature</button>
        <br><br>
          <!-- DataTables Example -->
          <div class="card mb-3">
            <div class="card-body">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                        ...
                        <th style="width:10%">Cases in Record</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $showData->casesrecord }}</td>
                            <td>
                              <div>
                                <a href="" data-target="#" data-toggle="modal"> <button type="button" class="btn btn-default btn-xs btn-filter"> <span style="color:#0460f4;" class="fas fa-edit"></span></button></a>
                                <a href="" data-target="#" data-toggle="modal"> <button type="button" class="btn btn-default btn-xs btn-filter"> <span style="color:#FF0000;" class="fas fa-trash"></span></button></a>
                              </div>
                            </td>
                        </tr>
                        @endforeach
