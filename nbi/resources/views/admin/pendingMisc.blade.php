...
<div class="card mb-3">
            ...
            <center><i class="fas fa-user-clock"></i>
                <font size="5">Pending Miscellaneous Cases</font>
            </center>
            </div>
           ...
           <!-- Dropdown for year -->
        <b><span>Year</span></b>
            <select name="year" id="year" style="width: 150px; height: 35px;">
        ...
        <!-- Dropdown for month -->
        <b><span>Month</span></b>
            <select name="month" id="month" style="width: 200px; height: 35px;">
          ...
          <b><span>TOTAL NO. OF CASES: </span></b> {{-- QUERY HERE --}}
        </div>
</div>
