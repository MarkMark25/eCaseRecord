...
<div class="col">
      ...
      <div id="content-wrapper">
          ...
          <div class="card mb-3">
            ...
            <center><i class="fas fa-folder"></i>
                <font size="5">Terminated Crime Cases</font>
            </center>
            </div>
      ...
      <!-- DataTables Example -->
            ...
            <b><span>TOTAL NO. OF RECEIVED AND TERMINATED CRIME CASES: </span></b> {{-- QUERY HERE --}}
          </div>
            </div>
          </div>
        </div>
